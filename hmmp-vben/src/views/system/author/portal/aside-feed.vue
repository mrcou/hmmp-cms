...
defineOptions({ name: 'AuthorPortalFeed' });
...
const tips = [
  {
    title: '投稿前请核对作者信息',
    desc: '确保通讯作者邮箱、单位信息准确，便于编辑部联系。',
  },
  {
    title: '退修稿请按时回复',
    desc: '收到退修意见后请尽快修订并重新上传，避免流程超时。',
  },
  {
    title: '关键词有助于检索',
    desc: '建议填写 3–5 个规范关键词，便于审稿与检索匹配。',
  },
];
...
<template>
  <aside class="author-portal-feed flex h-full flex-col gap-3 overflow-y-auto p-3">
